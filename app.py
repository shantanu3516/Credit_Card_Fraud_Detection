...
add_bg_from_local('Images/6.jpg')

# Title
st.title('UPI Fraud Detection Using Machine Learning ')
# Read Data into a Dataframe
df = pd.read_csv('creditcard.csv')
# --- 1 CHECKBOX ---
# Print description of the initial data and shape
if st.sidebar.checkbox('Dataset Selection '):
    st.header("Dataframe ")
...
# --- 2 CHECKBOX ---
if st.sidebar.checkbox('Dataset Preprocessing '):
...
# --- 4 CHECKBOX ---
if st.sidebar.checkbox('Machine Learning Algorithm '):
    # --- TRAIN AND TEST SPLIT ---
    # Putting feature variables into X
    X = df.drop(['Class'], axis=1)
